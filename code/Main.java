...
public class Main{
     ...
     */
    private static ArrayList<Option> readOptions (int startingIdx, int endingIdx, String[] optionStr){
     ...
     */
    private static Question booleanParsing(String questionText, String str, char category){
        ArrayList<Option> optionArray = new ArrayList<>(); 
        String[] optionStr = str.split(";");
